...
변환된 int 값: 3 */
        // 2. 강제 타입 변환
        double z = 3.141592;        System.out.println(z);
        int result2 = (int)z;        System.out.println(result2);
...
입력 예시: 첫 번째 정수 입력: 11, 두 번째 정수 입력: 21, 세 번째 정수 입력: 21
출력 예시: 평균 결과: 17.666666666666668 */
        // 4. 연산시 자동 타입변환
        ...
        double 평균 = (정수1 + 정수2 + 정수3) /3 ; // int 평균 = (정수1 + 정수2 + 정수3 ) /3
        // int + int + int / int -> int.   int + int + int / double = double
        System.out.println("평균: "+평균); // sout + 자동완성 , 가장 가까운 변수 출력 함수
