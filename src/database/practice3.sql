...
-- stock : 25
-- pub_date : '2023-03-01'
insert into books( book_id, title, author, genre, price, stock, pub_date ) values ( 1012, 'MySQL 실습', '김민수', '컴퓨터', 17000, 25, '2023-03-01' );
...
select title, genre from books where genre in ('컴퓨터' or '경제');
