...
public class Exam2 {
    public static void main(String[] args) {
        ...
        // [2] 종류
            ...
            // private: 비공개, 현재클래스 내에서만 호출 가능
            // (default) : 같은 / 하위 패키지에서만 호출 가능, 접근제한자 없을 경우 자동완성
            // protected : 같은 / 하위 패키지에서 호출 가능, + 상속관계 예외
        // [3] 사용법
        ...
        // [4] day07 폴더 내 package1폴더 생성 -> class A 생성
        // ====다른 클래스 : 접근 제한자 의미 유 ===== //
        A a = new A();
        ...
        // 자동완성 시 자동으로 최상단에 import.day07.package1.A;
