...
public class Exam1 {
    public static void main(String[] args) {
        ...
        System.out.println("localDate = "+ localDate); // sout+v
        // 1-2) (컴퓨터) 현재 시간 클래스
        ...
        LocalDateTime localDateTime2 = dateTime1.minusDays(30); // 30일 감소
        System.out.println("localDateTime2 = " + localDateTime2); // 2025-07-05T11:35:15
        // 1-7) 날짜 세부 정보
        ...
        System.out.println("second = " + second); // 33
