...
public class Practice17 {
    ...
    // [문제 1]
        Box<String> box1 = new Box<>();     box1.content = "안녕하세요";
        Box<Integer> box2 = new Box<>();    box2.content = 100;
    ...
    // [문제 3]
        ...
        Set<Integer> lottoSet = new HashSet<>(); // 집합(Set) 컬렉션 객체 생성
        for(int index =0; index<= draw.length -1; index++){ // 배열 순회
            lottoSet.add(draw[index]);        // index번째 번호를 set컬렉션 객체 대입 < 자동 중복제거 >
        }
    ...
    // [문제 4]
        ...
        System.out.println("treeSet = " + treeSet.descendingSet()); // .descendingSet() : 내림차순
    ...
    // [문제 6]
        System.out.println("map.containsKey(\"강호동\") =" + map.containsKey("강호동")); // .containskey("강호동") 결과 출력
        System.out.println("containsValue(65) = " +  map.containsValue(65)); // map.containsValue(65)결과 출력
