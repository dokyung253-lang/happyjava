...
public class Practice3 {
    ...
    입력 예시: 국어 점수: 85 영어 점수: 92 수학 점수: 78
    출력 예시: 총점: 255 평균: 85.0 */
        Scanner scan = new Scanner(System.in);  // main함수 안에서 입력객체는 1개 존재해도 된다.
        System.out.print("국어점수: ");  int 국어점수 = 85;
        System.out.print("영어점수: ");  int 영어점수 = 92;
        System.out.print("수학점수: ");  int 수학점수 = 78;
        int sum = 국어점수 + 영어점수 + 수학점수;
    ...
    출력 예시: 비율: 25.0% */
        ...
        double result3=(첫번째실수 / 두번째실수) * 100; // 2. 처리; 첫번째 실수가 두번째 실수의 몇 퍼센트인지
        System.out.println("result3 = "+ result3 + "%"); // 3. 출력; sout+v + 자동완성 : 가장 가까운 변수 출력
        // 변수명에 띄어쓰기 안됨, %나누기 기능이고, 백분율(%)은 문자이다
    ...
    출력 예시:
    결과: true */
        // 값 나누기 2 했을 떄 나머지가 0이면 짝수, 1이면 홀수
    ...
    출력 예시:
    결과: true */
        System.out.print("아이디: ");      String d3 = scan.next();
        System.out.print("비밀번호: ");    String d4 = scan.next();   //문자열입력 = String
        boolean result6 = d3.equals("admin") && d4.equals("1234");
    ...
    출력 예시:
    결과: true */
        System.out.print("정수: ");       int 정수1 = scan.nextInt();
        boolean result7 =  정수1 %2 ==1 && 정수1 % 7 == 0;
    ...
    출력 예시:
    결과: 합격 */
        System.out.print("1차 점수: ");    int a1 = scan.nextInt();
        System.out.print("2차 점수: ");    int a2 = scan.nextInt();
        int result8 = a1 + a2;
        System.out.println("결과: "+ (result8>150 ? "합격" : "불합격") );
    ...
    출력 예시 2:
    강호동 */   // 조건 ? 참 : 거짓
        // 입력받은 값이 "유재석"과 같으면 true{입력받은값"(방장)"} 아니면 false{입력받은 값}
        System.out.print("이름을 입력하세요: ");    String name1 = scan.next();
    ...
    출력 예시:
    삼각형의 넓이: 27.5
    */   //1. 입력방식 선택 : Scanner를 사용하여 double로 입력받아
        System.out.print("10] 밑변: ");       double 밑변 = scan.nextDouble(); //(저장) 추후에 계산하기 위해서
        System.out.print("10] 높이: ");       double 높이 = scan.nextDouble(); //(저장) 추후에 계산하기 위해서
        //2. 처리 로직: 삼각형 넓이를 계산
        double 계산결과 = 밑변 * 높이 /2.0; //(저장) 계산식 결과를 저장한다.
        //3. 출력하는 방식 선택 : 출력
        System.out.println("계산결과="+ 계산결과);
    ...
    입력 예시:    아이디: user1    이메일: admin@test.com
    출력 예시:    결과: 관리자 */ // 삼항연산자 필요 (~~이면 하면( 조건), 문자(true) 아니면/그렇지 않으면 등 문자(false)
        System.out.print("14] 아이디 : ");     String id1 = scan.next();
        System.out.print("14] 이메일 : ");    String em1 = scan.next();
        String result4 = (id1.equals("admin")|| (em1.equals("admin@test.com")))? "관리자" : "일반사용자";
    ...
    입력 예시:    점수를 입력하세요: 88
    출력 예시:    등급:B */
        System.out.print("15] 점수 : ");      int score= scan.nextInt();
