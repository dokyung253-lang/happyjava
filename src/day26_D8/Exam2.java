...
public class Exam2 {
    ...
    // Controller.getInstance();
        Controller controller1 = Controller.getInstance(); // 아래의 101번지 참조 = 101번지 // @4eec7777
        Controller controller2 = Controller.getInstance(); // 아래의 101번지 참조  = 101번지 // @4eec7777
        View view1 = new View(); // 102번지 // @682a0b20
        View view2 = new View(); // 103번지 // @3d075dc0
        ...
        // new 할 때 마다 주소값 (;메모리 ;인스턴스)가 생성된다.
    } // main end
} // class end

class Controller{ // 해당 클래스의 싱글톤 패턴 적용하기
    private Controller(){} // 1. 생성자를 private한다. 다른 클래스에서 new(호출) 불가 -> 객체 생성 불가
