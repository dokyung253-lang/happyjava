...
public class Exam1 {
    public static void main(String[] args) {
        ...
        리스트변수명.add( 1, "서장훈"); // .add(인덱스, 새로운 값) : 특정한 인덱스에 자료 추가
        System.out.println("리스트변수명 = " + 리스트변수명); // sout + v , [유재석, 서장훈, 강호동, 신동엽]
            // 5. 요소 수정 : .set( 인덱스, 새로운 값 ) 
        리스트변수명.set( 1, "박명수 ");
        System.out.println("리스트변수명 = " + 리스트변수명);
            // 6. 요소 총 갯수: .size() : 리스트 내 항목/요소 element/값 들의 총 갯수 반환
        ...
        System.out.println("찾은결과 = " + 찾은결과); // 강호동은 1번 인덱스에 위치한다.
            // 10. 요소 찾기2 : .contains(찾을값) : 찾을값이 존재하면 true, 없으면 false를 반환한다.
